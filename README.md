# HOW: Working with the SAS Extension for Visual Studio Code
...
![sas-ext-for-vs-code](/img/sas-vsc-featuresGlance.png)
...
This site provides the [hands-on instructions](/Working_with_the_SAS_Extension_for_VS_Code.md) for a SAS Innovate 2026 workshop provided by SAS Education.  The instructions in these pages are specific to the workshop and ***should not*** be considered a replacement for the official [SAS Documentation](https://documentation.sas.com). Some parts of these instructions will **only** work correctly in the Lab environments provided by SAS Education.
...
All content within this site is Copyright &copy; 2026 SAS Institute Inc. All Rights Reserved.
